...
bool jpsock::cmd_submit(const char* sJobId, uint32_t iNonce, const uint8_t* bResult, const char* backend_name, uint64_t backend_hashcount, uint64_t total_hashcount, fnostak_algo algo)
{
	char cmd_buffer[1024];
	char sNonce[9];
	char sResult[65];
