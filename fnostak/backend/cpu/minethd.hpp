...
public:
	...
	static cn_hash_fun func_selector(bool bHaveAes, bool bNoPrefetch, fnostak_algo algo);
...
private:
	...
	static cn_hash_fun_multi func_multi_selector(size_t N, bool bHaveAes, bool bNoPrefetch, fnostak_algo algo);
