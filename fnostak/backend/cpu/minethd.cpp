...
bool minethd::self_test()
{
	...
	if(::jconf::inst()->GetMiningAlgo() == cryptonight)
	{
		...
		hashf = func_selector(::jconf::inst()->HaveHardwareAes(), false, fnostak_algo::cryptonight);
		hashf("This is a test", 14, out, ctx[0]);
		bResult = memcmp(out, "\xa0\x84\xf0\x1d\x14\x37\xa0\x9c\x69\x85\x40\x1b\x60\xd4\x35\x54\xae\x10\x58\x02\xc5\xf5\xd8\xa9\xb3\x25\x36\x49\xc0\xbe\x66\x05", 32) == 0;

		hashf = func_selector(::jconf::inst()->HaveHardwareAes(), true, fnostak_algo::cryptonight);
		hashf("This is a test", 14, out, ctx[0]);
		bResult &= memcmp(out, "\xa0\x84\xf0\x1d\x14\x37\xa0\x9c\x69\x85\x40\x1b\x60\xd4\x35\x54\xae\x10\x58\x02\xc5\xf5\xd8\xa9\xb3\x25\x36\x49\xc0\xbe\x66\x05", 32) == 0;

		hashf_multi = func_multi_selector(2, ::jconf::inst()->HaveHardwareAes(), false, fnostak_algo::cryptonight);
		...
		hashf_multi = func_multi_selector(2, ::jconf::inst()->HaveHardwareAes(), true, fnostak_algo::cryptonight);
		hashf_multi("The quick brown fox jumps over the lazy dogThe quick brown fox jumps over the lazy log", 43, out, ctx);
		bResult &= memcmp(out, "\x3e\xbb\x7f\x9f\x7d\x27\x3d\x7c\x31\x8d\x86\x94\x77\x55\x0c\xc8\x00\xcf\xb1\x1b\x0c\xad\xb7\xff\xbd\xf6\xf8\x9f\x3a\x47\x1c\x59"
				"\xb4\x77\xd5\x02\xe4\xd8\x48\x7f\x42\xdf\xe3\x8e\xed\x73\x81\x7a\xda\x91\xb7\xe2\x63\xd2\x91\x71\xb6\x5c\x44\x3a\x01\x2a\x41\x22", 64) == 0;

		hashf_multi = func_multi_selector(3, ::jconf::inst()->HaveHardwareAes(), false, fnostak_algo::cryptonight);
		...
		hashf_multi = func_multi_selector(4, ::jconf::inst()->HaveHardwareAes(), false, fnostak_algo::cryptonight);
		...
		hashf_multi = func_multi_selector(5, ::jconf::inst()->HaveHardwareAes(), false, fnostak_algo::cryptonight);
...
minethd::cn_hash_fun minethd::func_selector(bool bHaveAes, bool bNoPrefetch, fnostak_algo algo)
{
...
minethd::cn_hash_fun_multi minethd::func_multi_selector(size_t N, bool bHaveAes, bool bNoPrefetch, fnostak_algo algo)
{
	// We have two independent flag bits in the functions
	// therefore we will build a binary digit and select the
	// function as a two digit binary
