...
#include "fnostak/backend/cpu/crypto/cryptonight_aesni.h"
#include "fnostak/backend/cpu/crypto/cryptonight.h"
#include "fnostak/misc/configEditor.hpp"
#include "fnostak/misc/console.hpp"
#include "fnostak/backend/cpu/minethd.hpp"
#include "fnostak/jconf.hpp"
#include "fnostak/misc/executor.hpp"
#include "fnostak/misc/environment.hpp"
#include "fnostak/params.hpp"
#include "fnostak/backend/cpu/hwlocMemory.hpp"
...
#endif
std::vector<iBackend*>* fnostak_start_backend(uint32_t threadOffset, miner_work& pWork, environment& env)
{
...
void minethd::work_main()
{
	...
	while (bQuit == 0)
	{
		...
		FNOSetJob(pGpuCtx, oWork.bWorkBlob, oWork.iWorkSize, target, miner_algo, version);
		...
		while(globalStates::inst().iGlobalJobNo.load(std::memory_order_relaxed) == iJobNo)
		{
			...
			FNORunJob(pGpuCtx, results, miner_algo, version);
