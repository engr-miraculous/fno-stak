...
public:
	static jconf* inst()
	{
		auto& env = fnostak::environment::inst();
	...
	inline fnostak_algo GetMiningAlgo() const { return mining_algo; }

	inline fnostak_algo GetMiningAlgoRoot() const { return mining_algo_root; }
...
private:
	...
	bool bHaveAes;
	fnostak_algo mining_algo;
	fnostak_algo mining_algo_root;
